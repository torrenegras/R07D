...
//myArray=[{email:"torrenegra.carlos@yahoo.com", name:"",type:"to"}]; //habilitar para pruebas
//myArray2=[{email:"torrenegra.carlos@yahoo.com", name:"",type:"to"}]; //habilitar para pruebas
